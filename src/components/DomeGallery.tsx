...
function buildItems(pool: (string | ImageInput)[], seg: number): ItemCoords[] {
  ...
  useEffect(() => {
    ...
    const close = () => {
      ...
      if (!originalPos) {
        ...
        if (parent) {
          (parent as HTMLElement).style.setProperty('--rot-y-delta', '0deg');
          (parent as HTMLElement).style.setProperty('--rot-x-delta', '0deg');
        }
      ...
      const cleanup = () => {
        ...
        if (parent) {
          ...
          p.style.setProperty('--rot-y-delta', '0deg');
          p.style.setProperty('--rot-x-delta', '0deg');
          requestAnimationFrame(() => {
                  ...
                  {it.src ? (
                    ...
                    <div
                      style={{
                        ...
                        border: '1.5px dashed rgba(187,204,215,0.35)',
